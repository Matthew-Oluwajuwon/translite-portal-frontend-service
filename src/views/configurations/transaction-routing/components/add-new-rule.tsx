...
const AddNewRule: React.FC = () => {
  ...
  return (
    <PageModal
      ...
      centered={true}
    >
      <Spin spinning={data.isLoading || data.isFetching || result.isLoading}>
                ...
                boundsRequestDTOS: [
                  {
                    ...
                    lowerBound: state.request.lowerBound,
                    upperBound: state.request.upperBound,
                  },
                ],
              },
              state.page,
            ...
            <div className="w-full">
              ...
              <Col span={24}>
                <Button
                  ...
                  htmlType="submit"
                  loading={
                    data.isLoading || data.isFetching || result.isLoading
                  }
